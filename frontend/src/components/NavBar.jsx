...
const NavBar = ({page,setIsSearch,setSearchQuery,getProducts}) => {
    ...
    return (
        <div className="dashboard-buttons">
            ...
            {(page!=="report")&&<SearchBar setIsSearch={setIsSearch} setSearchQuery={setSearchQuery} getProducts={getProducts}/>}
            <div className='dashboard-buttons-avatar' onClick={handleLogout}>
            <svg className="avatar"height="34px" width="34px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path fill="#555" d="M628.736 528.896A416 416 0 0 1 928 928H96a415.872 415.872 0 0 1 299.264-399.104L512 704l116.736-175.104zM720 304a208 208 0 1 1-416 0 208 208 0 0 1 416 0z"></path></g></svg>
            <span>
            <svg className='svg-logout' fill="#555" height="20px" width="20px" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="10 0 384.971 394.971">
                    <g>
